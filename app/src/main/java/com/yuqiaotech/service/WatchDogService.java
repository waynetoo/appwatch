    ...
    class ChildCallback implements Handler.Callback {
        ...
        public boolean handleMessage(Message msg) {
            ...
            if (!AppUtil.isAppRunning(getApplication(), (String) msg.obj)) {
                long lastUsedTime = AppUtil.getMoveForegroundTime(getApplication());
                // 表示界面静止超过
                if (-1 == lastUsedTime ) {
            ...
            childHandler.sendMessageDelayed(msg2, WatchConstants.WATCH_DOG_SERVICE_FRESH_TIME); //10s refresh again
            return false;
        }
    }
}
